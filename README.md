...
| **Deployed on Render with PostgreSQL + Redis** | ✅ |
...
This project is deployed on [Render](https://render.com) with:
- **PostgreSQL** database (managed service)
- **Redis** for WebSocket channel layers (managed service)
...
3. Add managed **PostgreSQL** and **Redis** services
...
```
5. Render auto-deploys → runs migrations → starts server
